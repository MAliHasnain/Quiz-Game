...
def changes():
    ...
    if choice1 == "view":
        ...
        if choice2 == "pst":
            file = open("CS21097_2.txt", "r")
            print(file.read())
            file.close()
            print('THANK YOU!!!')
        elif choice2 == "iq":
            file = open("CS21097_3.txt", "r")
            print(file.read())
            file.close()
            print('THANK YOU!!!')
        else:
        ...
        if choice3 =="pst":
            file=open("CS21097_2.txt","a+")
            file1=open("CS21097_4.txt","a+")
            ...
            file=open("CS21097_3.txt","a+")
            file1 = open("CS21097_5.txt", "a+")
            num = int(input("How many questins do you want to add?  "))
            for i in range(num):
...
def start():
    ...
    if (opt=="std"):
        ...
        if choice == "pst":
            with open("CS21097_2.txt", "r") as quesfile, open("CS21097_4.txt", "r") as ansfile:
            ...
            with open("CS21097_3.txt", "r") as quesfile, open("CS21097_5.txt", "r") as ansfile:
                questions = [question.strip() for question in quesfile.readlines()]
                answers = [answer.strip() for answer in ansfile.readlines()]
                score = 0
